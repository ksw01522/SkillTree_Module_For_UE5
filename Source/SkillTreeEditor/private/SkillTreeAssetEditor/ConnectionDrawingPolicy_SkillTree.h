...
class FConnectionDrawingPolicy_SkillTree : public FConnectionDrawingPolicy
{
protected:
	UEdGraph* GraphObj;
...
public:
	FConnectionDrawingPolicy_SkillTree(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
